...
namespace PrismCommonLib.Composition.Regions.Behaviors
{
    ...
    /// If you use the <see cref="PrismCommonLib.Regions.Region.Add(object,string,bool)" /> method with the createRegionManagerScope option, the scoped manager will be attached to the view.
    /// </remarks>
