...
namespace PrismCommonLib.Composition.Regions
{
    ...
    public class RegionBehaviorFactory : IRegionBehaviorFactory
    {
        ...
        public void AddIfMissing(string behaviorKey, Type behaviorType)
        {
            ...
            if (!typeof(IRegionBehavior).IsAssignableFrom(behaviorType))
            {
                throw new ArgumentException(
                    string.Format(Thread.CurrentThread.CurrentCulture, Application.Current.FindResource("CanOnlyAddTypesThatInheritIFromRegionBehavior").ToString(), behaviorType.Name), "behaviorType");
            }
        ...
        public IRegionBehavior CreateFromKey(string key)
        {
            ...
            {
                throw new ArgumentException(
                    string.Format(Thread.CurrentThread.CurrentCulture, Application.Current.FindResource("TypeWithKeyNotRegistered").ToString(), key), "key");
            }
