...
namespace PrismCommonLib.Composition.Regions
{
    ...
    public abstract class RegionAdapterBase<T> : IRegionAdapter where T : class
    {
        ...
        private static T GetCastedObject(object regionTarget)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, Application.Current.FindResource("AdapterInvalidTypeException").ToString(), typeof(T).Name));
            }
