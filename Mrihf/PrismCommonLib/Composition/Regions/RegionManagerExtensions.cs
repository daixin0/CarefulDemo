...
namespace PrismCommonLib.Composition.Regions
{
    ...
    public static class RegionManagerExtensions
    {
        ...
        public static IRegionManager AddToRegion(this IRegionManager regionManager, string regionName, object view)
        {
            ...
            if (!regionManager.Regions.ContainsRegionWithName(regionName))
            {
                throw new ArgumentException(
                    string.Format(Thread.CurrentThread.CurrentCulture, Application.Current.FindResource("RegionNotFound").ToString(), regionName), "regionName");
            }
        ...
        public static void Add(this IRegionCollection regionCollection, string regionName, IRegion region)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("RegionManagerWithDifferentNameException").ToString(), region.Name, regionName), "regionName");
            }
