    ...
    public class Region : IRegion
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture,Application.Current.FindResource("CannotChangeRegionNameException").ToString(), this.name));
                }

                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentException(Application.Current.FindResource("RegionNameCannotBeEmptyException").ToString());
                }
        ...
        public IRegionManager Add(object view, string viewName)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("StringCannotBeNullOrEmpty").ToString(), "viewName"));
            }
        ...
        private void InnerAdd(object view, string viewName, IRegionManager scopedRegionManager)
        {
            ...
            {
                throw new InvalidOperationException(Application.Current.FindResource("RegionViewExistsException").ToString());
            }
            ...
            if (!string.IsNullOrEmpty(viewName))
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture, Application.Current.FindResource("RegionViewNameExistsException").ToString(), viewName));
                }
        ...
        private ItemMetadata GetItemMetadataOrThrow(object view)
        {
            ...
            {
                throw new ArgumentException(Application.Current.FindResource("ViewNotInRegionException").ToString(), "view");
            }
