...
namespace PrismCommonLib.Composition.Regions
{
    ...
    public class RegionAdapterMappings
    {
        ...
        public void RegisterMapping(Type controlType, IRegionAdapter adapter)
        {
            ...
            if (mappings.ContainsKey(controlType))
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture,
                                                                  Application.Current.FindResource("MappingExistsException").ToString(), controlType.Name));
            }
        ...
        public IRegionAdapter GetMapping(Type controlType)
        {
            ...
            throw new KeyNotFoundException(String.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("NoRegionAdapterException").ToString(), controlType));
        }
    }
}