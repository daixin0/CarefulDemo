...
namespace PrismCommonLib.MefExtensions.Modularity
{
    /// <summary>
...
#pragma warning restore 0649
        ...
        public MefModuleInitializer(IServiceLocator serviceLocator, ILog loggerFacade, DownloadedPartCatalogCollection downloadedPartCatalogs, AggregateCatalog aggregateCatalog)
        ...
        protected override IModule CreateModule(ModuleInfo moduleInfo)
        {
            ...
            throw new ModuleInitializeException(
                string.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("FailedToGetType").ToString(), moduleInfo.ModuleType));
        }
    }
}