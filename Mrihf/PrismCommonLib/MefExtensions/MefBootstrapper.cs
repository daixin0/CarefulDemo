...
namespace PrismCommonLib.MefExtensions
{
    /// <summary>
    ...
    public abstract class MefBootstrapper : Bootstrapper
    {
        ...
        public override void Run(bool runWithDefaultConfiguration)
        {
            ...
            if (this.Logger == null)
            {
                throw new InvalidOperationException(Application.Current.FindResource("NullLoggerFacadeException").ToString());
            }

            this.Logger.Log(Application.Current.FindResource("LoggerWasCreatedSuccessfully").ToString(), LogLevel.Debug, Priority.Low);

            this.Logger.Log(Application.Current.FindResource("CreatingModuleCatalog").ToString(), LogLevel.Debug, Priority.Low);
            this.ModuleCatalog = this.CreateModuleCatalog();
            if (this.ModuleCatalog == null)
            {
                throw new InvalidOperationException(Application.Current.FindResource("NullModuleCatalogException").ToString());
            }

            this.Logger.Log(Application.Current.FindResource("ConfiguringModuleCatalog").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureModuleCatalog();

            this.Logger.Log(Application.Current.FindResource("CreatingCatalogForMEF").ToString(), LogLevel.Debug, Priority.Low);
            this.AggregateCatalog = this.CreateAggregateCatalog();

            this.Logger.Log(Application.Current.FindResource("ConfiguringCatalogForMEF").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureAggregateCatalog();

            this.RegisterDefaultTypesIfMissing();

            this.Logger.Log(Application.Current.FindResource("CreatingMefContainer").ToString(), LogLevel.Debug, Priority.Low);
            this.Container = this.CreateContainer();
            if (this.Container == null)
            {
                throw new InvalidOperationException(Application.Current.FindResource("NullCompositionContainerException").ToString());
            }

            this.Logger.Log(Application.Current.FindResource("ConfiguringMefContainer").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureContainer();

            this.Logger.Log(Application.Current.FindResource("ConfiguringServiceLocatorSingleton").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureServiceLocator();

            this.Logger.Log(Application.Current.FindResource("ConfiguringRegionAdapters").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureRegionAdapterMappings();

            this.Logger.Log(Application.Current.FindResource("ConfiguringDefaultRegionBehaviors").ToString(), LogLevel.Debug, Priority.Low);
            this.ConfigureDefaultRegionBehaviors();

            this.Logger.Log(Application.Current.FindResource("RegisteringFrameworkExceptionTypes").ToString(), LogLevel.Debug, Priority.Low);
            this.RegisterFrameworkExceptionTypes();

            this.Logger.Log(Application.Current.FindResource("CreatingShell").ToString(), LogLevel.Debug, Priority.Low);
            this.Shell = this.CreateShell();
            if (this.Shell != null)
            {
                this.Logger.Log(Application.Current.FindResource("SettingTheRegionManager").ToString(), LogLevel.Debug, Priority.Low);
                RegionManager.SetRegionManager(this.Shell, this.Container.GetExportedValue<IRegionManager>());

                this.Logger.Log(Application.Current.FindResource("UpdatingRegions").ToString(), LogLevel.Debug, Priority.Low);
                RegionManager.UpdateRegions();

                this.Logger.Log(Application.Current.FindResource("InitializingShell").ToString(), LogLevel.Debug, Priority.Low);
            ...
            {
                this.Logger.Log(Application.Current.FindResource("InitializingModules").ToString(), LogLevel.Debug, Priority.Low);
                this.InitializeModules();
            }

            this.Logger.Log(Application.Current.FindResource("BootstrapperSequenceCompleted").ToString(), LogLevel.Debug, Priority.Low);
        }
        ...
        {
            this.Container.ComposeExportedValue<ILog>(this.Logger);
