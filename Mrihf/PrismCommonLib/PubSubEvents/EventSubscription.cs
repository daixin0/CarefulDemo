...
namespace PrismCommonLib.PubSubEvents
{
    /// <summary>
    ...
    public class EventSubscription<TPayload> : IEventSubscription
    {
        ...
        public EventSubscription(IDelegateReference actionReference, IDelegateReference filterReference)
        {
            ...
            if (!(actionReference.Target is Action<TPayload>))
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture,Application.Current.FindResource("InvalidDelegateRerefenceTypeException").ToString(), typeof(Action<TPayload>).FullName), "actionReference");

            if (filterReference == null)
                throw new ArgumentNullException("filterReference");
            if (!(filterReference.Target is Predicate<TPayload>))
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("InvalidDelegateRerefenceTypeException").ToString(), typeof(Predicate<TPayload>).FullName), "filterReference");
