...
namespace Careful.Controls.DataGridControl.ConvertStringToLambda
{
    ...
    public class ExpressionParser
    {
        ...
        private UnaryExpression _param;
        ...
        public ExpressionParser([CanBeNull] ParameterExpression[] parameters, [NotNull] string expression, [CanBeNull] object[] values, [CanBeNull] ParsingConfig parsingConfig, Type sourceType = null)
        {
            ...
            if (parameters != null)
            {
                ProcessParameters(parameters, sourceType);
            }
        ...
        void ProcessParameters(ParameterExpression[] parameters,Type sourceType)
        {
            ...
            if (parameters.Length == 1)
            {
                _parent = _it;
                _it = parameters[0];
                _param = System.Linq.Expressions.Expression.TypeAs(_it, sourceType);
                if (_root == null)
                {
                    _root = _it;
                }
...
#pragma warning restore 0219
        ...
        Expression ParseIdentifier()
        {
            ...
            if (_it != null)
            {
                return ParseMemberAccess(null, _param);
            }
