...
namespace ControlResource.CustomControlsStyle
{
    public class ValueToProcessConverter : IValueConverter
    {
        ...
        private const int SuccessRateFontSize = 38;
        ...
        {
            NormalBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFADD3FF"));
            WarnBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFF5AC5F"));
        ...
        private Geometry GetGeometry(double value, double maxValue, double radiusX, double radiusY, double thickness, double padding)
        {
            ...
            double bigR = radiusX - thickness + padding+ Thickness;
