...
namespace ControlResource.ExtendControlStyle.NumericBox
{
    public class NumericBoxControl : TextBox
    {
        public NumericBoxControl()
        {
            ...
            listboxStyle.Source = new Uri("ControlResource;component/ExtendControlStyle/NumericBox/NumericBoxControlStyle.xaml", UriKind.Relative);
            this.Style = (System.Windows.Style)listboxStyle["txtSearch"];
        ...
        public static readonly DependencyProperty MinValueProperty =
            DependencyProperty.Register("MinValue", typeof(int), typeof(NumericBoxControl), new PropertyMetadata(1));
        ...
        public static readonly DependencyProperty MaxValueProperty =
            DependencyProperty.Register("MaxValue", typeof(int), typeof(NumericBoxControl), new PropertyMetadata(10));
