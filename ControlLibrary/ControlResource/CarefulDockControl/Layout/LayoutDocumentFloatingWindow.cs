		...
		public override void ReadXml(XmlReader reader)
		{
			...
			while (true)
			{
				...
				else
				{
					...
					if (type == null) throw new ArgumentException("Careful.Controls.CarefulDockControl.LayoutDocumentFloatingWindow doesn't know how to deserialize " + reader.LocalName);
