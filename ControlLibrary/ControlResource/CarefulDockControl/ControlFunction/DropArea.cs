...
namespace Careful.Controls.CarefulDockControl.ControlFunction
{
	...
	{
		/// <summary> This type of drop area identifies a <seealso cref="Careful.Controls.CarefulDockControl.DockingManager"/> which is the visual root of the Careful.Controls.CarefulDockControl control library.</summary>
		DockingManager,
