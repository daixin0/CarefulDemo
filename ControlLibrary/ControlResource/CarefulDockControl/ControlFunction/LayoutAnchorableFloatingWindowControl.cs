using Careful.Controls.CarefulDockControl.Converters;
...
namespace Careful.Controls.CarefulDockControl.ControlFunction
{
	...
	/// <summary>
	/// Class visualizes floating <see cref="LayoutAnchorable"/> (toolwindows) in Careful.Controls.CarefulDockControl.
	/// </summary>
