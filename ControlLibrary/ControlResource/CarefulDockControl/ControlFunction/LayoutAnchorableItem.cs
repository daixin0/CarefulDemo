...
namespace Careful.Controls.CarefulDockControl.ControlFunction
{
	...
	/// Implements the <see cref="Careful.Controls.CarefulDockControl.ControlFunction.LayoutItem" />
	///
	...
	/// </summary>
	/// <seealso cref="Careful.Controls.CarefulDockControl.ControlFunction.LayoutItem" />
