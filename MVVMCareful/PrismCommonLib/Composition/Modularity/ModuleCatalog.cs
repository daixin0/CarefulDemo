...
namespace PrismCommonLib.Composition.Modularity
{
    ...
    public class ModuleCatalog : IModuleCatalog
    {
            ...
            foreach (ModuleInfo moduleInfo in modules)
            {
                if (moduleInfo.DependsOn != null && moduleInfo.DependsOn.Except(moduleNames).Any())
                {
                    throw new ModularityException(
                        ...
                        String.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("ModuleDependenciesNotMetInGroup").ToString(), moduleInfo.ModuleName));
                }
            }
        }
        ...
        protected virtual void ValidateUniqueModules()
        {
            ...
            {
                throw new DuplicateModuleException(duplicateModule, String.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("DuplicatedModule").ToString(), duplicateModule));
            }
        }
        ...
        protected virtual void ValidateDependenciesInitializationMode()
        {
            ...
            if (moduleInfo != null)
            {
                throw new ModularityException(
                    moduleInfo.ModuleName,
                    String.Format(CultureInfo.CurrentCulture, Application.Current.FindResource("StartupModuleDependsOnAnOnDemandModule").ToString() , moduleInfo.ModuleName));
            }
        }
