    ...
    public class Region : IRegion
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, "reiong name not can changed", _name));
                }

                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentException("region name not can null");
                }
        ...
        public IRegionManager Add(object view, string viewName)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "string not can null or emtry", "viewName"));
            }
        ...
        public virtual object GetView(string viewName)
        {
            if (string.IsNullOrEmpty(viewName))
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "string not can null or empty", "viewName"));
            }
        ...
        private void InnerAdd(object view, string viewName, IRegionManager scopedRegionManager)
        {
            ...
            {
                throw new InvalidOperationException("region view exist");
            }
            ...
            if (!string.IsNullOrEmpty(viewName))
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture, "region view exist", viewName));
                }
        ...
        private ItemMetadata GetItemMetadataOrThrow(object view)
        {
            ...
            if (itemMetadata == null)
                throw new ArgumentException("view no exist region", nameof(view));
